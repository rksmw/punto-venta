...
try{
	...
	JasperReport jasperReport=(JasperReport)JRLoader.loadObject(path+"/report1.jasper");
	byte[] archivo=JasperRunManager.runReportToPdf(jasperReport, new HashMap(),conn);
	//response.reset();			
